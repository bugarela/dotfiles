...
(add-to-list 'org-entities-user '("faTrafficLight" "\\faTrafficLight[]" nil "<i class=\"fa fa-traffic-light\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faBulb" "\\faLightbulb[regular]" nil "<i class=\"fa-regular fa-lightbulb\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faProjectDiagram" "\\faProjectDiagram[]" nil "<i class=\"fa fa-project-diagram\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faNotEqual" "\\faNotEqual[]" nil "<i class=\"fa fa-not-equal\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faClock" "\\faClock[regular]" nil "<i class=\"fa-regular fa-clock\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faRoute" "\\faRoute[]" nil "<i class=\"fa fa-route\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faUserGraduate" "\\faUserGraduate[]" nil "<i class=\"fa fa-user-graduate\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faDice" "\\faDice[]" nil "<i class=\"fa fa-dice\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faLaptop" "\\faLaptop[]" nil "<i class=\"fa fa-laptop\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faUserEdit" "\\faUserEdit[]" nil "<i class=\"fa fa-user-edit\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faThumbsUp" "\\faThumbsUp[regular]" nil "<i class=\"fa-regular fa-thumbs-up\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faThumbsDown" "\\faThumbsDown[regular]" nil "<i class=\"fa-regular fa-thumbs-down\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faHandLizard" "\\faHandLizard[regular]" nil "<i class=\"fa-regular fa-hand-lizard\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faTasks" "\\faTasks[]" nil "<i class=\"fa fa-tasks\"></i>" "" "" ""))
(add-to-list 'org-entities-user '("faSync" "\\faSync[]" nil "<i class=\"fa fa-sync\"></i>" "" "" ""))
