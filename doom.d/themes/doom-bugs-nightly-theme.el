...
(def-doom-theme doom-bugs-nightly
  ...
  ((bg         '("#130416" nil       nil            ))
   ...
   (orange     '("#AF9386" "#AF8787" "brightred"    ))
   (green      '("#4F2E6E" "#4E4E4E" "green"        ))
   (teal       '("#AF8787" "#5F5F87" "brightgreen"  ))
   (yellow     '("#71539F" "#5F5FAF" "yellow"       ))
   (blue       '("#AB7793" "#AF8787" "brightblue"   ))
   (dark-blue  '("#8F5976" "#875F87" "blue"         ))
   (magenta    '("#6F5494" "#5F5F87" "magenta"      ))
   (violet     '("#8C73AF" "#875FAF" "brightmagenta"))
   (cyan       '("#D351AE" "#D75FAF" "brightcyan"   ))
   (dark-cyan  '("#BA2F93" "#AF0087" "cyan"         ))
